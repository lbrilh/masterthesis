'''
    Implementation of AnchorBoost and RefitLGBMRegressor.
'''
...
class AnchorBoost(BaseEstimator, RegressorMixin):
    """
    Boosted version of Anchor Regression. The residuals of Anchor Regression are fitted
    using a LGBMRegressor. 

    Parameters
    ----------
    anchor_params: dict
        Parameters for the Anchor Model.

    lgbm_params: dict
        Parameters for the LGBMRegressor
    """
