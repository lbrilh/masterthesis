...
grouping_column = 'services'


_data= load_data(f'parameters_{Regressor}_{grouping_column}')['hirid'].values
print(_data)
#print(len(_data))
...
_params_model=load_data(f'parameters_{Regressor}_{grouping_column}')['eicu'].values
error=[] 
